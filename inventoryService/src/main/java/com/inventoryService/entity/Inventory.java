...
import com.inventoryService.idGenerator.CustomeIdGenerator;
...
public class Inventory {
    ...
    @GenericGenerator(name="user_sql", strategy="com.inventoryService.idGenerator.CustomeIdGenerator", parameters = {
