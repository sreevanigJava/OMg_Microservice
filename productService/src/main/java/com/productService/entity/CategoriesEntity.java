...
import com.productService.idGenerator.CustomeIdGenerator;
...
public class CategoriesEntity {
    ...
    @GenericGenerator(name="user_sql", strategy="com.productService.idGenerator.CustomeIdGenerator", parameters = {
